...
class DhanTokenManager:
    ...
    def validate_token_with_api(self):
        ...
        """
        # Re-read .env fresh instead of trusting this process's os.environ - the
        # token may have been regenerated by a *different* process (e.g. the
        # algo-backend refresh cron writes it while algo-api is what's checking
        # here), and load_dotenv() at __init__ only ran once at process startup.
